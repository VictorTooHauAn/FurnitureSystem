...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnDelete" runat="server" Height="36px" Text="Delete" Width="69px" OnClick="btnDelete_Click" />
            <asp:Button ID="btnUpdate" runat="server" Height="36px" Text="Update" Width="69px" OnClick="btnUpdate_Click" />
